...
import { Grid, TextField, Typography, Button, Alert, Box } from "@mui/material";
import {
  FormControl,
  InputLabel,
  Select,
  ...
  return (
    <Box maxWidth="lg" mx="auto" p={3}>
      ...
      <div className="flex gap-4">
        <Box mt={2}>
          <CreateCustomer onClick={() => navigate("/create/customer")} />
        </Box>

        <Button
          variant="contained"
          onClick={handleSubmit}
          sx={{ mt: 3, backgroundColor: colors.SOLUTYICS_PURPLE }}
        >
          Submit Invoice
        </Button>
      </div>
        ...
        <Grid container spacing={1} key={index} alignItems="center" mb={1}>
          ...
          <Grid item xs={12} sm={1.5}>
            <TextField
              ...
              size="small"
              sx={{ maxWidth: 120 }} // limit input width
            />
          </Grid>
      ...
      <Box mt={4} textAlign="right">
        ...
        <Typography>Total Tax: ${calculateTotalTax().toFixed(2)}</Typography>
